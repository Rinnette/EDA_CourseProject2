# Question 1: Have total emissions from PM2.5 decreased in Baltimore City, Maryland from 1999 to 2008
...
# Create barplot and save to PNG file
        ...
        barplot(sumBC$Emissions, sumBC$year, names.arg = sumBC$year, col = "orange", 
                main = "Total PM 2.5 Emissions in Baltimore City", xlab = "Year", 
                ylab = "Sum of PM2.5 Emissions", ylim = c(0, 3500))
